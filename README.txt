...
The majority of the code is actually written in C although packaged within CPP files.

ArduinoCores is a break-away set of low-level core library files that are
in the process of being improved and extended. Improving the source code format
